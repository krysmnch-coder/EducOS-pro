...
// Base de données GLOBALE (utilisateurs, connexions)
...
// Base de données de l'établissement (données spécifiques)
...
function setEtablissementDb(dbPath) {
    ...
    etablissementDb = new sqlite3.Database(dbPath, (err) => {
        if (err) {
            ...
            console.log(' Connecté à la base établissement:', path.basename(dbPath));
...
function createEtablissementTables() {
    ...
    etablissementDb.serialize(() => {
        ...
        etablissementDb.run(`CREATE TABLE IF NOT EXISTS absences (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            eleve_id INTEGER NOT NULL,
            date_absence DATE NOT NULL,
            type TEXT NOT NULL CHECK(type IN ('absence', 'retard')),
            motif TEXT DEFAULT 'Non justifié',
        ...
        etablissementDb.run(`CREATE TABLE IF NOT EXISTS emploi_du_temps (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
        ...
        etablissementDb.run(`CREATE TABLE IF NOT EXISTS pointage (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
        ...
        etablissementDb.run(`CREATE TABLE IF NOT EXISTS sanctions (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            eleve_id INTEGER NOT NULL,
            ...
            duree TEXT,
            notifie_parent INTEGER DEFAULT 0,
            created_at DATETIME DEFAULT CURRENT_TIMESTAMP
        )`);

        etablissementDb.run(`CREATE TABLE IF NOT EXISTS notes (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            eleve_id INTEGER NOT NULL,
            matiere TEXT NOT NULL,
            classe TEXT NOT NULL,
        ...
        etablissementDb.run(`CREATE TABLE IF NOT EXISTS ressources (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            prof_id INTEGER NOT NULL,
            titre TEXT NOT NULL,
            type TEXT NOT NULL,
        ...
        etablissementDb.run(`CREATE TABLE IF NOT EXISTS devoirs_rendus (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
        ...
        etablissementDb.run(`CREATE TABLE IF NOT EXISTS paiements (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            type TEXT NOT NULL,
        ...
        etablissementDb.run(`CREATE TABLE IF NOT EXISTS messages (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            expediteur_id INTEGER NOT NULL,
            destinataire_id INTEGER,
            destinataire_role TEXT DEFAULT 'all',
            sujet TEXT NOT NULL,
        ...
        etablissementDb.run(`CREATE TABLE IF NOT EXISTS notifications (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
        ...
        etablissementDb.run(`CREATE TABLE IF NOT EXISTS amis (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            eleve_id INTEGER NOT NULL,
        ...
        etablissementDb.run(`CREATE TABLE IF NOT EXISTS groupes (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            nom TEXT NOT NULL,
            photo TEXT,
        ...
        etablissementDb.run(`CREATE TABLE IF NOT EXISTS membres_groupes (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            groupe_id INTEGER NOT NULL,
            eleve_id INTEGER NOT NULL
        )`);

        etablissementDb.run(`CREATE TABLE IF NOT EXISTS messages_groupes (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            groupe_id INTEGER NOT NULL,
            expediteur_id INTEGER NOT NULL,
            contenu TEXT NOT NULL,
        ...
        etablissementDb.run(`CREATE TABLE IF NOT EXISTS messages_amis (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            expediteur_id INTEGER NOT NULL,
        ...
        etablissementDb.run(`CREATE TABLE IF NOT EXISTS avertissements (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            prof_id INTEGER NOT NULL,
            mois TEXT NOT NULL,
            total_minutes_retard INTEGER DEFAULT 0,
            avertissement_active INTEGER DEFAULT 0,
            message_avertissement TEXT,
            created_at DATETIME DEFAULT CURRENT_TIMESTAMP
        )`);
