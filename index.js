...
if (process.env.NODE_ENV === 'production') {
  ...
  sessionStore = new pgSession({
    ...
    // createTableIfMissing: true, // On désactive cette option. La création de la table doit être gérée
    // exclusivement par les migrations pour garantir la stabilité en production.
  });
} else {
